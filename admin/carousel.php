...
<body class="bg-light">
                ...
                <div class="card border-0 shadow-sm mt-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Hero Images</h5>
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#hero_s">
                                <i class="bi bi-plus-square"></i> Add
                            </button>
                        </div>
                        <div class="row" id="hero_data">

                        </div>
                    </div>
                </div>

                <!-- hero Settings Modal Section -->
    ...
    <script src="page-scripts/hero.js"></script>
